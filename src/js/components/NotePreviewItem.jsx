...
function NotePreviewItem({item, selectNote}) {
  ...
  return (
  <li data-testid="note-preview-item" tabIndex="0" onKeyPress={(e) => e.key === "Enter" && selectNoteForEditingThenRedirect(item.id)} onClick={() => selectNoteForEditingThenRedirect(item.id)} className="note-preview-item">
